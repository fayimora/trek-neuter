// Generated on 2013-05-01 using generator-ember 0.2.4
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            neuter:{
                files: ['<%= yeoman.app %>/scripts/**/*.js'/*, '!<%= yeoman.app %>/scripts/app.js'*/],
        ...
        neuter: {
            app: {
                options: {
                  filePathTransform: function(filepath){ return template.process('<%= yeoman.app %>/scripts/') + filepath; }
                },
